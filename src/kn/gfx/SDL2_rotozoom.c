...
{
    int x, y, sx, sy, ssx, ssy, *sax, *say, *csax, *csay, *salast, csx, csy, ex, ey, cx, cy, sstep,
        sstepx, sstepy;
...
/*!
\brief Rotates and zooms a surface with different horizontal and vertival scaling factors and
                               ...
                               int smooth)
{
    ...
    if (fabs(angle) > VALUE_LIMIT)
    {
        ...
        if (is32bit)
        {
             ...
             */
            rz_dst = SDL_CreateRGBSurface(SDL_SWSURFACE, dstwidth, dstheight + GUARD_ROWS, 32,
        ...
        else
        {
             ...
             */
            rz_dst = SDL_CreateRGBSurface(SDL_SWSURFACE, dstwidth, dstheight + GUARD_ROWS, 8, 0, 0,
                                          0, 0);
        }
...
SDL_Surface* zoomSurface(SDL_Surface* src, double zoomx, double zoomy, int smooth)
{
    ...
    else
    {
         ...
         */
        rz_dst =
            SDL_CreateRGBSurface(SDL_SWSURFACE, dstwidth, dstheight + GUARD_ROWS, 8, 0, 0, 0, 0);
    }
